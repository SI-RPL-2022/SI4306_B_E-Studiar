...
<div class="row justify-content-center" style="margin-top: 90px">
  ...
  <div class="col-lg-6">
    <main class="form-registration">
      <h1 class="h3 mb-4 fw-normal text-center">Mentor | Masuk Estudiar</h1>
      <form action="/mentor/login" method="POST">
        @csrf
      ...
      <small class="d-block mt-3">Belum punya akun Estudiar? <a class="text-primary" href="/mentor/registrasi"> Daftar
          disini</a></small>
    </main>
  </div>
</div>
